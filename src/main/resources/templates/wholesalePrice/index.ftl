        ...
        <div class="col-xs-12">
            ...
            <div>
                <div id="dynamic-table_wrapper" class="dataTables_wrapper form-inline no-footer">
                    <form method="get" action="/admin/wholesalePrice" id="wholesalePriceform">
                    <div class="row">
                        <div class="col-xs-10">
                            <div class="dataTables_length" id="dynamic-table_length">
                               ...
                               <label>vip类型: <select name="vipType" ">
                                        <option <#if (vipType!5)==5>selected</#if> value="">全部</option>
                        ...
                        <div>
                            ...
                            <a href="/admin/wholesalePrice/edit" class="btn btn-white btn-info btn-bold">
                                新增
                            </a>
                        </div>
                    </div>
                    ...
                    <table id="dynamic-table" class="table table-striped table-bordered table-hover dataTable no-footer" aria-describedby="dynamic-table_info">
                        ...
                        <tr role="row">
                            ...
                            <th class="sorting_disabled" tabindex="0" rowspan="1" colspan="1">采购价格</th>
                            <th class="sorting_disabled" tabindex="0"  rowspan="1" colspan="1" >采购数量区间开始</th>
                            <th class="sorting_disabled" tabindex="0"  rowspan="1" colspan="1" >采购数量区间结束</th>
                        ...
                        <tr role="row" class="odd">
                            ...
                            <td>${list.vipPrice!}</td>
                            <td>${list.vipCountStart!}</td>
                            <td>${list.vipCountEnd!}</td>
                            <td>
                                <#if list.state==0>失效</#if>
                                <#if list.state==1>有效</#if>
                            </td>
                            <td>
                                <#if list.state==1> <a class="red" onclick="del(${list.id})">
...
<script type="text/javascript">
    jQuery(function($) {
        ...
        new page({pageMain:"pagination",nowPage:${page!'1'},count:${count},pageSize:${pageSize!'10'},
            url:"/admin/wholesalePrice",params:"?pageSize=${pageSize}&orderState=${orderState!}",pakey:"page"});
    ...
    function del(id) {
        bootbox.confirm({
                ...
                callback: function(result) {
                    if(result) {
                        quickAjax({
                            url: '/admin/wholesalePrice/delete',
                            method:"POST",
                            data:{
                                id:id
                            },
